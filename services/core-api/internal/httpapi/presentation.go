...
type saleResponse struct {
	...
	AccountingTimeBasis  sales.AccountingTimeBasis `json:"accounting_time_basis"`
...
func presentSale(value sales.Sale) saleResponse {
	...
	return saleResponse{
		...
		CreatedBy: value.CreatedBy, CorrelationID: value.CorrelationID,
		DocumentAt: value.DocumentAt, ReceivedAt: value.ReceivedAt,
		AccountingAt: value.AccountingAt, AccountingTimeBasis: value.AccountingTimeBasis,
