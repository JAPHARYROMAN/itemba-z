...
It is not yet the complete production Release 1 ERP. Remaining settings depth, statutory integrations, production migrations, and the formal release gates remain tracked in [the implementation status](docs/implementation/current-status.md).
