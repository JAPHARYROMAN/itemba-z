...
ITEMBA-Z core ERP functional coverage is **91.7%**. This is a weighted implementation score for executable Release 1 business surfaces, not a production-readiness score and not permission to launch.
