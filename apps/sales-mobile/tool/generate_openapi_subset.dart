...
const _requiredMarkers = <String>[
  '/v1/customers:',
  'operationId: listCustomers',
  '/v1/products:',
  'operationId: listProducts',
  '/v1/mobile/sync/sales:',
  'operationId: syncMobileSale',
  '/v1/mobile/devices/enroll:',
  'operationId: enrollMobileDevice',
  'CustomerSummary:',
  'ProductSummary:',
...
Future<void> main(List<String> arguments) async {
  ...
  if (arguments.any((value) => value != '--check')) {
    stderr.writeln(
      'Usage: dart run tool/generate_openapi_subset.dart [--check]',
    );
    exitCode = 64;
    return;
  }
  final script = File.fromUri(Platform.script);
  final specification = File.fromUri(
    script.uri.resolve('../../../contracts/openapi/itemba-z.v1.yaml'),
  );
  final output = File.fromUri(
    script.uri.resolve('../lib/generated/itemba_z_v1.dart'),
  );
  final source = await specification.readAsString();
  final missing = _requiredMarkers.where((marker) => !source.contains(marker));
  if (missing.isNotEmpty) {
    stderr.writeln(
      'OpenAPI contract is missing required mobile markers: ${missing.join(', ')}',
    );
    exitCode = 2;
    return;
  }
  ...
  final generated = await _formatDart(
    _template.replaceAll('@@SPEC_SHA256@@', hash),
  );
  if (check) {
    if (!await output.exists() || await output.readAsString() != generated) {
      stderr.writeln(
        'Generated mobile API contract is stale. Run: '
  ...
  stdout.writeln('Generated ${output.path} from ${specification.path}');
}

Future<String> _formatDart(String source) async {
  final directory = await Directory.systemTemp.createTemp(
    'itemba-z-api-codegen-',
  );
  try {
    final file = File.fromUri(directory.uri.resolve('generated.dart'));
    ...
    // Windows can briefly retain the formatter's file handle after the child
    // process exits. Cleanup is retried without making code generation fail.
...
const _template = r'''// GENERATED CODE - DO NOT MODIFY BY HAND.
// Source: contracts/openapi/itemba-z.v1.yaml
// Generator: tool/generate_openapi_subset.dart

// ignore_for_file: avoid_dynamic_calls

const String itembaZV1SpecificationSha256 = '@@SPEC_SHA256@@';
...
class GeneratedMobileStockAllocation {
  ...
  factory GeneratedMobileStockAllocation.fromJson(Object? value) {
    ...
    return GeneratedMobileStockAllocation(
      ...
      allocatedQuantity: _integer(json['allocated_quantity'], 'allocated_quantity'),
      remainingQuantity: _integer(json['remaining_quantity'], 'remaining_quantity'),
    );
  }
...
class GeneratedMobileDeviceEnrollment {
  ...
  factory GeneratedMobileDeviceEnrollment.fromJson(Object? value) {
    ...
    return GeneratedMobileDeviceEnrollment(
      ...
      masterDataVersion: _integer(json['master_data_version'], 'master_data_version'),
      priceVersion: _integer(json['price_version'], 'price_version'),
      catalogSnapshotToken: _string(json['catalog_snapshot_token'], 'catalog_snapshot_token'),
      ...
      stockAllocations: _list(json['stock_allocations'], 'stock_allocations')
          .map(GeneratedMobileStockAllocation.fromJson)
...
class GeneratedCustomerSummary {
  ...
  factory GeneratedCustomerSummary.fromJson(Object? value) {
    ...
    return GeneratedCustomerSummary(
      ...
      status: _string(json['status'], 'status'),
      isGeneralCustomer: _boolean(json['is_general_customer'], 'is_general_customer'),
      creditEnabled: _boolean(json['credit_enabled'], 'credit_enabled'),
      creditLimitMinor: _integer(json['credit_limit_minor'], 'credit_limit_minor'),
...
class GeneratedCustomerPage {
  const GeneratedCustomerPage({required this.items, required this.catalogSnapshotToken, required this.masterDataVersion, required this.priceVersion, this.nextCursor});
  ...
  factory GeneratedCustomerPage.fromJson(Object? value) {
    ...
    return GeneratedCustomerPage(
      items: _list(json['items'], 'items')
          .map(GeneratedCustomerSummary.fromJson)
          .toList(growable: false),
...
class GeneratedProductSummary {
  ...
  factory GeneratedProductSummary.fromJson(Object? value) {
    ...
    return GeneratedProductSummary(
      ...
      availableQuantity: _integer(json['available_quantity'], 'available_quantity'),
...
class GeneratedProductPage {
  const GeneratedProductPage({required this.items, required this.catalogSnapshotToken, required this.masterDataVersion, required this.priceVersion, this.nextCursor});

  factory GeneratedProductPage.fromJson(Object? value) {
    final json = _map(value, 'ProductPage');
    return GeneratedProductPage(
      items: _list(json['items'], 'items')
          .map(GeneratedProductSummary.fromJson)
          .toList(growable: false),
      nextCursor: json['next_cursor'] as String?,
      catalogSnapshotToken: _string(json['catalog_snapshot_token'], 'catalog_snapshot_token'),
      masterDataVersion: _integer(json['master_data_version'], 'master_data_version'),
...
class GeneratedSaleLineCommand {
  const GeneratedSaleLineCommand({required this.productId, required this.quantity});
  final String productId;
  final int quantity;
...
class GeneratedSaleResult {
  ...
  factory GeneratedSaleResult.fromJson(Object? value) {
    ...
    return GeneratedSaleResult(
      ...
      receiptReference: _string(json['receipt_reference'], 'sale.receipt_reference'),
...
class GeneratedMobileSyncResult {
  ...
  factory GeneratedMobileSyncResult.fromJson(Object? value) {
    ...
    return GeneratedMobileSyncResult(
      clientTransactionId: _string(json['client_transaction_id'], 'client_transaction_id'),
      state: _string(json['state'], 'state'),
      receiptReference: _string(json['receipt_reference'], 'receipt_reference'),
      fiscalStatus: GeneratedFiscalStatus.fromJson(json['fiscal_status']),
      idempotentReplay: _boolean(json['idempotent_replay'], 'idempotent_replay'),
...
typedef GeneratedJsonExecutor = Future<GeneratedJson> Function({
