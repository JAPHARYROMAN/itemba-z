...
export default async function NewLiveSalePage({ searchParams }: { searchParams: Promise<{ order?: string }> }) {
  ...
  return <LiveSaleEntry bootstrap={snapshot.data} initialSourceDocumentId={order} />;
}
